...
export function DashboardContentWrapper({
  ...
  return (
    <div
      ...
      */
      className="flex-1 min-h-0 p-0 lg:p-3 transition-all"
      style={{
        backgroundColor:
    ...
    >
      ...
      */}
      <main className="h-full min-h-screen lg:min-h-0 overflow-y-auto overscroll-contain rounded-none lg:rounded-[24px] bg-white dark:bg-zinc-900 shadow-sm">
        {children}
      </main>
    </div>
  )
